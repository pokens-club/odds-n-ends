...
// This contract is an example of an NFT vault that rewards based on the rarity score of NFT and combination boost of combined NFTs.
// Created within the context of allowing collection based staking that boosts rewards if certain collections are completed.
